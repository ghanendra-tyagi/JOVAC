...
// 
// const ghanendraAssignment = new Promise(function(resolve, reject){
    // setTimeout(()=>{
        // console.log("I am ghanendra!!!");
    // },5000);
// });
// 
// function RamTask(){
    // const ghanendraDocs = ghanendraAssignment;
    // console.log("DATA", ghanendraAssignment);
    // console.log("BYE")
// }
// 
// RamTask();
...
// constghanendrahAssignment = function(){
//     setTimeout(()=>{
...
// function RamTask(){
//     const data = ghanendraAssignment;
...
//     setTimeout(()=>{
//         console.log("GHANENDRA STARTED WORK")
//         resolve("I am ghanendra !!");
//     },5000);
// });
...
//     console.log("FILE RECEIVED AND CHECKED!!!", GHANENDRA);
//     console.log("Class End")
// }
...
// const student = {name: "GHANENDRA"}
// const student2 = {name: "RAM"}

// // admissionProcess("Hello GHANENDRA", " HII");
...
// },true)
function tyagi(resolve,reject){
    setTimeout(()=>{
        console.log(" hii i am tyagi ");
    },4000)
}
